export default function Input({
  ...
  const dryStyle = "w-full px-3 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#2C2C2C] text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-[#7F39FB]";

  const base = "transition focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-[#7F39FB] dark:bg-[#2C2C2C] dark:text-white";

  const variantStyles = {
    default: "w-full px-4 py-2 border border-gray-300 rounded-md",
    compact: "w-20 px-2 py-1 border border-gray-300 rounded bg-white dark:bg-[#2C2C2C] text-gray-800 dark:text-white text-sm",
